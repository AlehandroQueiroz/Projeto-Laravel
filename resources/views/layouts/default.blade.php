...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item px-3 dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('funcionarios.create')}}">Cadastar Novo</a></li>
                            <li><a class="dropdown-item" href="{{ route('funcionarios.index')}}">Listar Todos</li>
    ...
    <div class="container mb-5 p-4 position-relative">
        @yield('conteudo')
    </div>
